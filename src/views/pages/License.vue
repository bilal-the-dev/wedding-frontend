...
function searchProducts(event) {
    productSuggestions.value = ['Product A', 'Product B', 'Product C', 'Product D', 'Product E'].filter((item) => item.toLowerCase().startsWith(event.query.toLowerCase()));
}

function searchClientDiscord(event) {
    clientDiscordSuggestions.value = ['client A', 'Client B', 'Product C', 'Product D', 'Product E'].filter((item) => item.toLowerCase().startsWith(event.query.toLowerCase()));
}
